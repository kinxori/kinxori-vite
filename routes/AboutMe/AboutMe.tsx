        ...
        <article className="aboutMe-root">
            ...
            <div className="about-me-read-more-content">
                <div className="aboutme-copy-PFP">
                    <img src="/273048005_1274448366400567_4493743372539204487_n.jpg" alt="Gustavo Quiroz - Kinxori"></img>
                </div>
                <h3>
                    Where I come from? 🌎
                </h3>
                ...
                <p>
                    ...
                    After graduating with a degree in Animation and Visual Effects in 2020, 
                    I landed a job as a 2D Cut-Out Animator and Background Illustrator from 2020-2021. 
                    This was just the start of my journey, as I eventually progressed to become a 
                    Lead Motion Graphic Artist in a Canadian marketing agency in mid-2021.
                </p>
                <p>
                    Although I had a successful career in the visual arts industry, 
                    I felt the need to learn new skills and broaden my horizons. 
                    This is why in October 2022, I decided to start learning web development. 
                    My passion for problem-solving and creating meaningful experiences through 
                    web design grew, and in January 2023, I made the decision to pursue web development as a 
                    full-time job.
                </p>
                <p>
                    Currently, I am focusing on developing myself as a Front-End Developer, 
                    and I am determined to become a Full-Stack Developer in the near future. 
                    My career journey has been an exciting and fulfilling experience, 
                    and I look forward to what the future holds as I continue to grow and evolve as a developer.                   
                </p>
                <h3>
                    Hobbies? 🍿
                </h3>
